...
export default function Pagination({ totalPages, changeHandler }: PaginationPropsType) {
    ...
    return (
        <div className="flex items-center justify-center gap-3">
            ...
            {/* Page Numbers */}
            <div className={`bg-[#f3f3f3] px-2 py-1 flex items-center rounded-full drop-shadow`}>
