...
export default function CustomPopup({
    ...
    const handleClosePopup = () => setPopupOptions((prev) => ({ ...prev, open: false }));
        ...
        <>
            ...
            >
                ...
                <header className={`p-4 flex justify-between items-center drop-shadow shadow`}>
                    {/* TITLE */}
                    <h1 className={`m-0 text-2xl font-semibold py-1.5`}>{popupOptions.title}</h1>
                ...
                {/* CONTENT */}
                <div className={`p-2.5 flex-1 overflow-hidden overflow-y-scroll scroll-smooth`}>
                    {children}
                </div>
            </Popup>
        </>
